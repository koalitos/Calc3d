...
```
cert/
├── certificado-lucas.pfx          # Certificado Windows (atual)
...
signtool verify /pa dist/Calc3DPrint-Setup-*.exe
```
...
# Verificar assinatura
codesign -dv --verbose=4 dist/mac/Calc\ 3D\ Print.app

# Verificar notarização
spctl -a -vv -t install dist/Calc3DPrint-*.dmg
```
