...
const releaseNotes = `# 🎉 Calc 3D Print v${version}

> **Sistema Completo para Calcular Custos de Impressão 3D**
...
### 🪟 Windows
- **Calc3DPrint-Setup-${version}.exe** (Recomendado)
- Requisitos: Windows 10/11 (64-bit)

### 🍎 macOS
- **Calc3DPrint-${version}-arm64.dmg** (Apple Silicon - M1/M2/M3)
- Requisitos: macOS 10.15 ou superior

### 🐧 Linux
- **Calc3DPrint-${version}-x64.AppImage** (Universal)
- **calc3dprint_${version}_amd64.deb** (Debian/Ubuntu)
...
- [README completo](https://github.com/koalitos/calc3D/blob/main/README.md)
...
- [Reportar Bug](https://github.com/koalitos/calc3D/issues/new)
- [Sugerir Funcionalidade](https://github.com/koalitos/calc3D/issues/new)
