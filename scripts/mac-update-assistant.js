/**
 * 🍎 Assistente de Atualização para macOS - Calc 3D Print
 * 
  ...
  async getLatestRelease() {
    return new Promise((resolve, reject) => {
      const options = {
        ...
        path: '/repos/koalitos/Calc3d/releases/latest',
        method: 'GET',
        headers: {
          'User-Agent': 'Calc3D-Updater'
        }
      };
      ...
      setTimeout(() => {
        dialog.showMessageBox(this.mainWindow, {
          ...
          detail: 'Para instalar a atualização:\n\n' +
                  '1. Arraste o Calc 3D Print para a pasta Aplicativos\n' +
